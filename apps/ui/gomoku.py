...
class GomokuUI(GameUI):
    def __init__(self, players: list['Player'], rows=15, columns=15):
        ...
        self.black_piece = pygame.image.load('./apps/assets/graphics/gomoku/black.png')
        self.white_piece = pygame.image.load('./apps/assets/graphics/gomoku/white.png')
        self.mark_pic = pygame.image.load('./apps/assets/graphics/gomoku/circle.png')
        self.cursor_pic = pygame.image.load('./apps/assets/graphics/gomoku/cursor.png')
    ...
    def draw_victory_badge(self):
        ...
        path = f'apps/assets/graphics/gomoku/{winner}_win.png'
